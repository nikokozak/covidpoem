...
var _papaparseMinJs = require("./papaparse.min.js"); // CSV Parser
var _papaparseMinJsDefault = parcelHelpers.interopDefault(_papaparseMinJs);
var _micromodal = require("micromodal"); // Modal handler
var _micromodalDefault = parcelHelpers.interopDefault(_micromodal);
var _utilsJs = require("./utils.js"); // Custom helpers
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
var _timerJs = require("./timer.js"); // Custom timer for clocks
var _chartsJs = require("./charts.js"); // Chart wrapper
...
/* ---------------- */ //	MAIN PAGE DATA //
/* ---------------- */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto5/TotalesNacionales_T.csv").then((response)=>{
    // Parse response with PapaParse
    let result = (0, _papaparseMinJsDefault.default).parse(response.data, PARSEOPTIONS);
    // Remove rows that had a parsing error
    result = (0, _utilsJsDefault.default).removeErrorRows(result);
    // -- DEBUG -- console.log('Main Page results:', result)
    // Get the latest data item from the data array.
    let latestData = (0, _utilsJsDefault.default).getLatestData(result);
    // Adjust text on page.
    (0, _utilsJsDefault.default).setValue("refreshDate", (0, _utilsJsDefault.default).getDate(latestData));
    // Refresh counters.
    (0, _utilsJsDefault.default).setValue("totalCount", (0, _utilsJsDefault.default).getTotalCount(latestData));
    (0, _utilsJsDefault.default).setValue("newCount", (0, _utilsJsDefault.default).getNewCount(latestData));
    (0, _utilsJsDefault.default).setValue("activeCount", (0, _utilsJsDefault.default).getActiveCount(latestData));
    (0, _utilsJsDefault.default).setValue("recoveredCount", (0, _utilsJsDefault.default).getRecoveredCount(latestData));
    (0, _utilsJsDefault.default).setValue("deadCount", (0, _utilsJsDefault.default).getDeadCount(latestData));
    // Calculate wrangled numbers (difference of dead between yesterday/today, etc)
    let deadYesterday = (0, _utilsJsDefault.default).diffDataFromEnd(0, 1, "Fallecidos", result);
    let newCountDiff = (0, _utilsJsDefault.default).diffDataFromEnd(0, 1, "Casos nuevos totales", result);
    (0, _utilsJsDefault.default).setValue("newCountYesterday", (0, _utilsJsDefault.default).formatNumber(Math.abs(newCountDiff)));
    // Handle lexical switch based on neg/pos numbers.
    (0, _utilsJsDefault.default).setValue("switchNew", (0, _utilsJsDefault.default).switchFormat(newCountDiff, "m\xe1s", "menos"));
    (0, _utilsJsDefault.default).setValue("yesterdayDeadCount", deadYesterday);
    // Calculate days-to-duplicate
    let duplicateDays = (0, _utilsJsDefault.default).getDuplDayCount(latestData);
    (0, _utilsJsDefault.default).setValue("dupTime", duplicateDays);
    // Timers
...
/* ---------------- */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto20/NumeroVentiladores_T.csv").then((response)=>{
    ...
    let latestData = (0, _utilsJsDefault.default).getLatestData(result);
    // Refresh count.
    (0, _utilsJsDefault.default).setValue("ventilatorCount", (0, _utilsJsDefault.default).getVentilatorCount(latestData));
    // Chart handler.
    (0, _chartsJs.handleClick)("ventilatorCount", "Ventiladores Disponibles", (0, _chartsJs.formatData)(10, "disponibles", "Ventiladores", result));
});
...
/* ---------------- */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto9/HospitalizadosUCIEtario_T.csv").then((response)=>{
    ...
    let latestData = (0, _utilsJsDefault.default).getLatestData(result);
    // Refresh count.
    (0, _utilsJsDefault.default).setValue("bedCount", (0, _utilsJsDefault.default).getBedCount(latestData));
    // -- DEBUG -- console.log('UCI Bed count:', _h.getBedCount(result.data))
    // Chart handler.
    (0, _chartsJs.handleClick)("bedCount", "Pacientes en UCI", (0, _chartsJs.formatData)(10, "y", "x", (0, _utilsJsDefault.default).getBedCount(result.data)));
});
/* ---------------- */ //	PCR TESTING DATA //
/* ---------------- */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto17/PCREstablecimiento_std.csv").then((response)=>{
    ...
    // Refresh count. 
    (0, _utilsJsDefault.default).setValue("testCount", (0, _utilsJsDefault.default).getTestingCount(latestData));
    // Chart hanlder.
    (0, _chartsJs.handleClick)("testCount", "Testeo Diario", (0, _chartsJs.formatData)(10, "y", "x", (0, _utilsJsDefault.default).getTestingCount(result.data)));
});
/* ---------------- */ //	INFEC RATE DATA //
/* ---------------- */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto12/bulk/producto7.csv").then((response)=>{
    let result = (0, _papaparseMinJsDefault.default).parse(response.data, PARSEOPTIONS);
    let latestData = (0, _utilsJsDefault.default).meanDataFromEnd(16, "Tasa", result);
    // Refresh count.
    (0, _utilsJsDefault.default).setValue("rateCount", latestData);
});
...
/* ------------------------ */ axios.get("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto29/Cuarentenas-Activas.csv").then((response)=>{
    ...
    (0, _utilsJsDefault.default).setValue("quarantineList", (0, _utilsJsDefault.default).getQuarantineList(result.data));
});
console.log("Hello hola!!");

},{"./papaparse.min.js":"2pw9C","micromodal":"cjhRo","./utils.js":"en4he","./timer.js":"1h9uQ","./charts.js":"kkiZQ","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2pw9C":[function(require,module,exports) {
/* @license
Papa Parse
v5.0.2
...
*/ !function(e, t) {
    ...
    if (b.RECORD_SEP = String.fromCharCode(30), b.UNIT_SEP = String.fromCharCode(31), b.BYTE_ORDER_MARK = "\uFEFF", b.BAD_DELIMITERS = [
        ...
        '"',
        b.BYTE_ORDER_MARK
    ], b.WORKERS_SUPPORTED = !n && !!f.Worker, b.NODE_STREAM_INPUT = 1, b.LocalChunkSize = 10485760, b.RemoteChunkSize = 5242880, b.DefaultDelimiter = ",", b.Parser = E, b.ParserHandle = r, b.NetworkStreamer = l, b.FileStreamer = c, b.StringStreamer = p, b.ReadableStreamStreamer = m, f.jQuery) {
        var d = f.jQuery;
    ...
    function r(g) {
        ...
        this.parse = function(e, t, r) {
            ...
            if (g.newline || (g.newline = function(e, t) {
                ...
                var r = new RegExp(U(t) + "([^]*?)" + U(t), "gm"), i = (e = e.replace(r, "")).split("\r"), n = e.split("\n"), s = 1 < n.length && n[0].length < i[0].length;
                ...
                var n = function(e, t, r, i, n) {
                    ...
                    for(var u = 0; u < n.length; u++){
                        ...
                        for(var p = new E({
                            ...
                            newline: t,
                            preview: 10
                        }).parse(e), m = 0; m < p.data.length; m++)if (r && v(p.data[m])) c++;
                        else {
...
const _h = function() {
    ...
    function removeErrorRows(parseObj) {
        ...
        for (const index of errorRows)parseObj.data.splice(index, 1);
        return parseObj;
    }
    ...
    function getBedCount(parseData, format = true) {
        ...
        if (Array.isArray(parseData)) {
            ...
            result = parseData["<=39"] + parseData["40-49"] + parseData["50-59"] + parseData["60-69"] + parseData[">=70"];
            return format ? formatNumber(result) : result;
        }
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1h9uQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeTimer", ()=>makeTimer);
parcelHelpers.export(exports, "countdownClock", ()=>countdownClock);
var _utilsJs = require("./utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
// Activate timer, returning stream of formatted text.
function makeTimer(id, column, data) {
    let diff = Math.abs((0, _utilsJsDefault.default).diffDataFromEnd(0, 1, column, data));
    let seconds = Math.round(86400 / diff);
...
},{"./utils.js":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kkiZQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function formatData(numRows, column, dateColumn, data) {
    ...
    let formatted = tail.map((d)=>{
        return {
            x: new Date(d[dateColumn]),
            y: d[column]
        };
    });
...
},{"chart.js":"kmlOB","micromodal":"cjhRo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kmlOB":[function(require,module,exports) {
/*!
 * Chart.js v2.9.4
...
},{}]},["itx18","gLLPy"], "gLLPy", "parcelRequired6b0")
